...
if __name__ == '__main__':
    ...
    roc_curves = results_embedding_GO.pop("roc_curves")  # Extract ROC curve data
    savefile(results_embedding_GO, pr_curves,roc_curves, outpath, filename="embedding_GO.csv")
